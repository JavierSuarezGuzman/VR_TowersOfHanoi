...
[System.Serializable]
public class GrabBegin_Event : UnityEvent<bool>
{
}
...
{
    public GrabBegin_Event grabBegin_Event;
    public UnityEvent grabEnd_Event;
    ...
    virtual public void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity)
    {
        ...
        grabEnd_Event.Invoke();
    }

    void Awake()
    {
        if (grabBegin_Event == null)
            grabBegin_Event = new GrabBegin_Event();
        if (grabEnd_Event == null)
            grabEnd_Event = new UnityEvent();
