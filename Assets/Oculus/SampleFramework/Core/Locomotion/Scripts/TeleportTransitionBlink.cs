...
/*
Assets\Oculus\SampleFramework\Core\Locomotion\Scripts\TeleportTransitionBlink.cs(71,10): error CS1061: 'OVRScreenFade' does not contain a definition for 'SetFadeLevel' and no accessible extension method 'SetFadeLevel' accepting a first argument of type 'OVRScreenFade' could be found (are you missing a using directive or an assembly reference?)
*/
	/// <summary>
